// Tämä on lainattu koodia opettajan (Tommi Tuikka) kurssilla läpkäydyistä koodeista.
  ...
  if (token) {
    ...
    jwt.verify(token, secret, function (err, decoded) {
      if (err) {
        ...
        req.decoded = decoded;
        next(); // siirrytään eteenpäin, tässä tapauksessa suorittamaan kontrollerin metodi, esim. post.
      }
    });
  } else {
